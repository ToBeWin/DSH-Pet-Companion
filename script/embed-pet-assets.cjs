...
const assets = Object.fromEntries(['beaver', 'cat', 'axolotl', 'shiba', 'rabbit', 'corgi', 'hamster', 'otter', 'penguin', 'red-panda', 'fox', 'panda', 'golden-retriever', 'koala', 'duckling', 'raccoon'].map((id) => [
  id,
